...
class BooksApp extends React.Component {
  ...
  render() {
    const currentlyReading = 
      [
        {
          title: 'To Kill a Mockingbird', authors: 'Harper Lee', coverWidth: 128, coverHeight: 193,
          ...
          title: 'Ender\'s Game', authors: 'Orson Scott Card', coverWidth: 128, coverHeight: 188,
    ...
    const wantToRead = 
      [
        {
          title: '1776', authors: 'David McCullough', coverWidth: 128, coverHeight: 193,
          ...
          title: 'Harry Potter and the Sorcerer\'s Stone', authors: 'J.K. Rowling', coverWidth: 128, coverHeight: 192,
      ...
      [
        {
          title: 'The Hobbit', authors: 'J.R.R. Tolkien', coverWidth: 128, coverHeight: 192,
          ...
          title: 'Oh, the Places You\'ll Go!', authors: 'Seuss', coverWidth: 128, coverHeight: 174,
        ...
        {this.state.showSearchPage ? (
          ...
          <div className="list-books">
            ...
            <div className="list-books-content">
              <div>
                <Bookshelf title="Currently Reading" list="currentlyReading" books={currentlyReading} />
                <Bookshelf title="Want to Read" list="wantToRead" books={wantToRead} />
                <Bookshelf title="Read" list="read" books={read} />
              </div>
            </div>
